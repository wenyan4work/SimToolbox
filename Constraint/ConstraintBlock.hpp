...
struct ConstraintBlock {
  public:
    ...
    double sepDist = 0;                   ///< seperation distance TODO: modularize and delete this
    double kappa = 0;                     ///< spring forcing term TODO: modularize and delete this
    double gamma = 0;                     ///< actual force lagrange multiplier
    double gammaGuess = 0;                ///< force lagrange multiplier initial guess
     ...
     * 
     * TODO: modularize! The fact that I have to store kappa is atrocious
     */
    ConstraintBlock(double sepDist_, double gammaGuess_, double kappa_, int gidI_, int gidJ_, int globalIndexI_, int globalIndexJ_,
                    const double normI_[3], const double normJ_[3], const double posI_[3], const double posJ_[3],
                    const double labI_[3], const double labJ_[3], bool oneSide_, bool bilateral_)
        : sepDist(sepDist_), gammaGuess(gammaGuess_), kappa(kappa_), gidI(gidI_), gidJ(gidJ_), globalIndexI(globalIndexI_),
