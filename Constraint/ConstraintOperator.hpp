 ...
 * Du^T, Db^T, M, and K^{-1} are explicitly constructed before constructing this
 * object
 */
...
public:
  ...
  /**
   * @brief return if this operator can be applied as transposed. interface
   * required by Tpetra::Operator
   *
   * @return true
   * @return false
   */
