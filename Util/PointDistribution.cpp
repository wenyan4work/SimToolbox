...
void randomUniformFill(std::vector<double> &vec, double low, double high, int seed) {
...
void randomLogNormalFill(std::vector<double> &vec, double a, double b, int seed) {
...
void checkError(const std::vector<double> &valueLocal, const std::vector<double> &valueTrueLocal, const double bar) {
