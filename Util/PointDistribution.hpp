 ...
 */
void dumpPoints(const std::string &filename, std::vector<double> &coord,
 ...
 * @param value
 * @param valueTrue
 * @param bar if not zero, compares max error with bar and print error
 * information
 */
void checkError(const std::vector<double> &value,
                const std::vector<double> &valueTrue, const double bar = 0);
