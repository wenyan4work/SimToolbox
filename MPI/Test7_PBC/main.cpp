...
// get the result of imposePBC and verify the result.
...
int main(int argc, char **argv) {
  ...
  testUniform(2000, 2000, 1, -100, 100, pbcBox, comm_rank, comm_size);

  pbcBox[1] = -1;
  // non-uniformly distributed
  testNonUniform(2000, 2000, 1, 5, 2, pbcBox, comm_rank, comm_size);
