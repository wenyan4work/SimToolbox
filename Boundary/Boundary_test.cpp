...
int main() {
...

  {
    ...
    std::unique_ptr<Boundary> b =
        std::make_unique<SphereShell>(center, 2.0, true);
  ...
  }
  {
    ...
    std::unique_ptr<Boundary> b =
        std::make_unique<SphereShell>(center, 2.0, false);
    for (long i = 0; i < 1000; i++) {
      Evec3 query = (Evec3::Random() * 5) + Emap3(center);
      Evec3 projection = Evec3::Zero();
      Evec3 normI = Evec3::Zero();
...

  {
    ...
    std::unique_ptr<Boundary> b =
        std::make_unique<Tube>(center, axis, 2.0, true);
    for (long i = 0; i < 1000; i++) {
      Evec3 query = (Evec3::Random() * 5) + Emap3(center);
      Evec3 projection = Evec3::Zero();
      Evec3 normI = Evec3::Zero();
  ...
  }
  {
    ...
    std::unique_ptr<Boundary> b =
        std::make_unique<Tube>(center, axis, 2.0, false);
    for (long i = 0; i < 1000; i++) {
      Evec3 query = (Evec3::Random() * 5) + Emap3(center);
      Evec3 projection = Evec3::Zero();
      Evec3 normI = Evec3::Zero();
