#ifndef SylinderNearEP_HPP_
#define SylinderNearEP_HPP_
...
static_assert(std::is_trivially_copyable<NearForce>::value, "");
...
void CalcSylinderNearForce::operator()(const SylinderNearEP *const ep_i, const PS::S32 Nip,
                                       const SylinderNearEP *const ep_j, const PS::S32 Njp,
                                       NearForce *const forceNear) {
...
void CalcSylinderNearForce::collideStress(const Evec3 &dirI, const Evec3 &dirJ, const Evec3 &posI, const Evec3 &posJ,
