...
- Change `/Users/wyan/local` to the folder you want to install. `$HOME/local` recommended. Avoid `/usr/local`, because it is difficult to cleanup if you want to upgrade or switch to the debug version
